...
export const ITEMS = [
  ...
  it('headphones', 'Headphones', 'ordinary', 28, 'tool', 'plastic'),
  ...
  it('skateboard', 'Skateboard', 'ordinary', 40, 'tool', 'wood'),
  it('desk_lamp', 'Desk Lamp', 'ordinary', 24, 'bulb', 'metal'),
  it('backpack_old', 'Old Backpack', 'ordinary', 26, 'box', 'fabric'),
  it('wallet', 'Leather Wallet', 'ordinary', 30, 'box', 'leather'),
  it('sunglasses', 'Sunglasses', 'ordinary', 32, 'tool', 'plastic'),
  it('toolbox', 'Small Toolbox', 'ordinary', 38, 'box', 'metal'),
  it('frying_pan', 'Frying Pan', 'ordinary', 16, 'disc', 'metal'),
  it('board_game', 'Board Game', 'ordinary', 21, 'box', 'paper'),
  it('bluetooth_spkr', 'Bluetooth Speaker', 'ordinary', 33, 'box', 'plastic'),
  it('camera_compact', 'Compact Camera', 'ordinary', 45, 'box', 'metal'),
  ...
  it('vintage_camera', 'Vintage Camera', 'rare', 150, 'box', 'leather'),
  ...
  it('drone', 'Camera Drone', 'rare', 165, 'box', 'plastic'),
  it('gold_watch', 'Pocket Watch', 'rare', 140, 'watch', 'gold'),
  it('tablet', 'Tablet', 'rare', 100, 'phone', 'glass'),
  it('designer_bag', 'Designer Handbag', 'rare', 190, 'box', 'leather'),
